...
public class MainServer extends UnicastRemoteObject implements GetRemoteDatabaseService,Runnable {
    public static final int MAX_CHUNK_SIZE = 1000;
    public static final String DEFAULTDATABASE = "databaseDB.db";

    private final String databasePath = DatabaseConnection.DATABASE_URL;
    ...
    public MainServer(String[] args) throws RemoteException{
        this.args = args;
    }
    ...
    //META 1 - Server Main Thread
    public void MainServerThread(String[] args) {
